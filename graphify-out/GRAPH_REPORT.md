...
## Corpus Check
- 74 files · ~2,499,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 358 nodes · 357 edges · 72 communities (45 shown, 27 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7e8d8a7`
...
## Knowledge Gaps
- **115 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+110 more)
...
- **Why does `Home Page` connect `Community 1` to `Community 4`?**
